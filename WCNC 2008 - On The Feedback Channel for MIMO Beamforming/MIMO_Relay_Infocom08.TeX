...
MIMO channel with frequency-selective block fading, which means
the random channels taps remain constant for some data packets and
...
design} by {superimposed pilot pattern}, in this paper.
